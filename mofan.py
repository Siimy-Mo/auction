...
class PositionEmbedding(keras.layers.Layer):
    def __init__(self, max_len, model_dim, n_vocab):
        ...
        self.embeddings = keras.layers.Embedding(
            ...
            embeddings_initializer=tf.compat.v1.keras.initializers.RandomNormal(0., 0.01),
        )
...
class Transformer(keras.Model):
    ...
    def call(self, x, y, training=None):
        ...
        pad_mask = self._pad_mask(x) # 64 1 1 12
        encoded_z = self.encoder.call(x_embed, training, mask=pad_mask) # 64 12 32
...
if __name__ == "__main__":
    ...
    m = Transformer(MODEL_DIM, MAX_LEN, N_LAYER, N_HEAD, d.num_word, DROP_RATE) # d.num_word = 27
    train(m, d, step=800)
